...
y_train = (x_train.take(axis=1, indices=3).take(axis=1, indices=1) + 1) ** 4
...
model.add(SimpleRNN(16, input_shape=x_train.shape[1:]))
...
model.fit(x_train, y_train, batch_size=32, epochs=20, verbose=1, validation_split=0.5)
